...
<h1 style="color: #D10024">Thông báo đặt hành thành công</h1>
<base href="{{asset(' ')}}">
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" valign="middle" style="width:500px;height:60px">
                                        <a href="#" style="border:0; background-color: #393b3b;" target="_blank" width="130" height="35" style="display:block;border:0px">
                                            <img src="https://simfree-pc.net/wp-content/uploads/2018/06/thinkpad-logo-white.png" style="max-width: 200px; max-height: 70px;" alt="">
                                        </a>
                                    </td>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="left" valign="middle" style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;padding:0 10px 20px 10px;line-height:17px">
                                        ...
                                        <br> Cám ơn bạn đã mua sắm tại <i>Thinkpad </i>
                                        <br>
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="2" align="left" valign="top" style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#666666;padding:10px 10px 20px 15px;line-height:17px"> 
                                        ...
                                        <a href="#" style="color:#ed2324;font-weight:bold;text-decoration:none" target="_blank">{{$code_order}}
                                        </a>
                                ...
                                <tr>
                                    <td align="left" valign="top" style="width:120px;padding-left:15px">
                                        <a href="#_" style="border:0"> 
                                            <img src="https://m.media-amazon.com/images/I/51SPLLQGUIL._AC_UY218_ML3_.jpg" height="120" width="120" style="display:block;border:0px"> 
                                        </a>
                                    </td>
