                    ...
                    <div class="tab-content">
                                                        ...
                                                        <div class="position-center">
                                                            ...
                                                            <form role="form" action="{{URL::to('admin-update-product')}}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required  type="text" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="product name" >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required  type="text" name="product_price" class="form-control" id="exampleInputEmail1" placeholder="price"   >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                </div>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required  type="text" name="product_vat" class="form-control" id="exampleInputEmail1" placeholder="vat" >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required  style="resize:none" rows="3" class="form-control" name="product_quantity" id="exampleInputPassword1" placeholder="quantity" >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required   type="text" name="product_meta_tag_title" class="form-control" id="exampleInputEmail1" placeholder="meta tag title" >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required  type="text" name="product_meta_tag_keywords" class="form-control" id="exampleInputEmail1" placeholder="meta tag keywords"  >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input required  type="text" name="product_tags" class="form-control" id="exampleInputEmail1" placeholder="tags"  >
                                                                    </div>
                                                                    <br>
                                                                    <hr>
                                                                </div>
                                    ...
                                    <div class="tab-pane" id="tab-data">
                                        ...
                                        <div class="form-group  ">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="cpu_technology" placeholder="Model" id="cpu-technology" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="cpu_types" id="cpu_types" class="form-control" placeholder="cpu types" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="cpu_speed" id="cpu_speed" class="form-control" placeholder="cpu speed" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="cpu_caching" id="cpu_caching" class="form-control" placeholder="cpu caching">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="maximum_speed_turbo" id="maximum_speed_turbo" class="form-control" placeholder="maximum_speed_turbo" >
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="ram_memory" id="ram_memory" class="form-control" placeholder="ram memory">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="ram_types" id="ram-types" class="form-control" placeholder="ram types">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="speed_bus" id="speed-bus" class="form-control" placeholder="speed bus">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="technology_mh" id="technology-mh" class="form-control" placeholder="Technology MH" >
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="radio-inline"> <input required  type="radio" name="time_used_often" value="3h ~ 4h"> 3h ~ 4h </label>
                                                <label class="radio-inline"> <input required  type="radio" name="time_used_often" value="6h ~ 8h"> 6h ~ 8h </label>
                                                <label class="radio-inline"> <input required  type="radio" name="time_used_often" value="8h ~ 12h"> 8h ~ 12h </label>
                                                <label class="radio-inline"> <input required  type="radio" name="time_used_often" value="13h ~ 21h"> 13h ~ 21h </label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <input required  type="text" name="charger" id="charger" class="form-control" placeholder="65W AC, Lenovo AC Adapter">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <input required  type="text" name="dimensions"  placeholder="Length" id="input-length" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input required  type="text" name="weight" id="input-weight" class="form-control" placeholder="Weight (kg)" >
                                            </div>
                                        </div>
                                        <hr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="text-left">
                                                            ...
                                                            <input required  type="file" class="file" name="product_image" onchange="readURL(this);" />
                                                        </td>
                                                    </tr>
                                            ...
                                            <table id="images" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tfoot>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <input required  type="file"   name="product_detail{{$i}}" title="product_detail{{$i}}" required />
                                                        <input required  type="hidden" name="item{{$i}}" title="item{{$i}}" required>
                                                        </td>
                                                    </tr>
                                                    @endfor
                                                </tfoot>
